syms k z a; % Declarar las variables simbólicas (k, z, y la cte a)
...
k_valores = 0:20; % Aumentar el número de puntos
...
% Visualización de la señal transformada:
subplot(2, 1, 2); % Agregado para la transformada
ezplot(Tz2, [0, 2, -1, 1]);  % Añadido rango y labels.
title('Transformada Z de f(k)');
xlabel('Re{z}');
ylabel('Im{z}');
grid on;
